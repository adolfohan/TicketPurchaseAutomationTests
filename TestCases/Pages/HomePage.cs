...
public class HomePage
{
    ...
    private By MeInteresaButton => By.XPath("//a[contains(@class, 'sv-button sv-button--type-contained sv-button--size-sm sv-button--color-primary') and contains(text(), 'Me interesa')]");
    ...
    public void ClickRandomMeInteresaButton()
    {
        ...
        {
            int randomIndex = new Random().Next(0, meInteresaButtons.Count);
            IWebElement buttonToClick = meInteresaButtons[randomIndex];

            IJavaScriptExecutor jsExecutor = (IJavaScriptExecutor)driver;
            jsExecutor.ExecuteScript("arguments[0].scrollIntoView({behavior: 'auto', block: 'center'});", buttonToClick);
            //Thread.Sleep(1000);
